...
2. Activate the TypoScript
   ...
   3. Click the link **Edit the whole template record** and switch to the tab
      *Includes*.
   4. Select **[NITSAN] ns_twitter** at the field *Include static
      (from extensions):*
   5. Include **[NITSAN] ns_twitter** at the last place.

![TYPO3_NsTwitter_Extension_NITSAN_Install_Step2](./images/TYPO3_NsTwitter_Extension_NITSAN_Install_Step2.webp)

## How to Install TYPO3 Extension ns_twitter
