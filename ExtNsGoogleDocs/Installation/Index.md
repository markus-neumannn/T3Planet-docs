...
```
composer req nitsan/ns-googledocs --with-all-dependencies
```
...
Step 3. Get it from the Extension Manager: Press the “Retrieve/Update” button and search for the extension key ns_googledocs and import the extension from the repository.
