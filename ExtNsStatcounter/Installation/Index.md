...
![installation with the extension manager in the backend](./images/TYPO3_StatsCounter_Extension_NITSAN_Backend_Install_Extensions.jpeg)
...
2. Activate the TypoScript
   ...
   3. Click the link **Edit the whole template record** and switch to the tab
      *Includes*.
   4. Select **[NITSAN] ns_statcounter** at the field *Include static
      (from extensions):*
   5. Include **[NITSAN] ns_statcounter** at the last place.

![installation](./images/TYPO3_StatsCounter_Extension_NITSAN_Backend_Include_Static_Template.webp)

## How to Install TYPO3 Extension ns_statcounter
