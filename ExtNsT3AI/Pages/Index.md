...
<Note>
Generated content elements are stored on colpos 0
</Note>
...
**Action:** Build AI Page Tree

**Steps:**

1. Go to **T3AI tab → Pages → Build AI Page Tree.**
2. Choose AI model and prompt → Click **Generate AI.**
3. Select generated pages, edit/delete/regenerate as needed → Click **Create AI Page Tree.**
4. Page tree is created. Go to “Selected Page” → View **Generated Page Tree.**
...
**Action:** Build AI Blog Tree

**Steps:**

1. Go to TYPO3 Page Tree → Select blog root page.
2. From T3AI dropdown → Select **AI Page Tree.**
3. Choose AI model, add prompt → Click **Generate Page Tree.**
4. Edit/save → Blog tree generated.
...
**Action:** Publish AI News

**Steps:**

1. T3AI tab → Pages → **Create AI News (Simple).**
2. Choose AI model, select prompt, add topic + keywords, set results → Click **Generate AI.**
3. Edit news (headline, URL, teaser, text, keywords, meta). Optionally use **Get AI Suggestions.**
4. Go to **List Module → Storage Folder → View Generated News.**
...
1. T3AI tab → Pages → **Create AI News (Advanced).**
2. Choose AI model, prompt, topic, keywords, style, and results → Click **Generate AI.**
3. Select outline → Click **Generate Content → Save News Records.**
4. Edit (headline, URL, teaser, keywords, meta). Use **Get AI Suggestions.**
5. List Module → Storage Folder → View Generated News.
...
**Action:** Generate AI Blog

**Steps:**

1. T3AI tab → Pages → **Generate AI Blog.**
2. Select AI model, add topic + keywords → Click **Generate.**
3. Content is added to blog page.
...
1. T3AI tab → Pages → **Generate AI Blog.**
2. Select AI model, add topic, generate outline.
3. Add elements/images → Content generated into blog page.
