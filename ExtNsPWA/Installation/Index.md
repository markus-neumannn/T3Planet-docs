...
```
composer require nitsan/ns-pwa --with-all-dependencies
```
...
Step 3. Get it from the Extension Manager: Press the “Retrieve/Update” button and search for the extension key ns_pwa and import the extension from the repository.

Step 4. Get it from typo3.org: You can always get the current version from https://extensions.typo3.org/extension/ns_pwa/ by downloading either the t3x or zip version. Upload the file afterwards in the Extension Manager.
...
Step 4. Select TYPO3 PWA (Progressive Web Apps)(ns_pwa)

Step 5. Include PWA (Progressive Web Apps)(ns_pwa) at the last place.

![Activate Typoscript](./images/activate_typoscript.webp)

## How to Install TYPO3 Extension ns_pwa
...
![Install Extension](./images/install_extension1.png)
