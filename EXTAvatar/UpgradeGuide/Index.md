---
title: "Upgrade Guide"
description: "This product's greater then v3.3.0 is major breaking changes to migrate from outdated EXT.gridelements to modern EXT.container."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3 Avatar"
...
<Steps>
  <Step title="Step 1">
Open System → T3Planet Shop (TYPO3 v12/v13: Admin Tools → T3Planet Shop; older versions: NITSAN > License Manager) and update to latest version of EXT.ns_theme_t3avatar
  </Step>
  <Step title="Step 2">
Update EXT.ns_basetheme atleast v11.5.x
  </Step>
  <Step title="Step 3">
