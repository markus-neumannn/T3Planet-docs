...
![installation with the extension manager in the backend](./images/TYPO3-EXTns_sharethis-Install_1.jpeg)
...
2. Activate the TypoScript
   ...
   3. Click the link **Edit the whole template record** and switch to the tab
      *Includes*.
   4. Select **[NITSAN] ns_sharethis** at the field *Include static
      (from extensions):*
   5. Include **[NITSAN] ns_sharethis** at the last place.

![installation](./images/TYPO3-EXTns_sharethis-Install_2.webp)

## How to Install TYPO3 Extension ns_sharethis
