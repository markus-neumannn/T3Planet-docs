...
Step 3. Get it from the Extension Manager: Press the “Retrieve/Update” button and search for the extension key ns_news_slider and import the extension from the repository.
...
Step 4. Select [NITSAN] News Slider at the field Include static (from extensions):

Step 5. Include [NITSAN] News Slider at the last place.

![Activate Typoscript](./images/activate_typoscript.webp)

## How to Install TYPO3 Extension ns_newsslider
