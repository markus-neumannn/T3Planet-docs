...
description: "This guide walks through endtoend testing of all three connection methods and every client tab in the backend module T3AF MCP Server."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3AF"
  - "MCP Server — Testing guide"
sidebarTitle: "MCP Server — Testing guide"
---

This guide walks through **end-to-end testing** of all three connection methods and every client tab in the backend module (T3AF > MCP Server).
...
lists Core tools from T3AF (for example `table_schema`, `pages_get`,
...
**Token in URL**
After creating a token, the server accepts: `https://<host>/mcp?token=<64-char-hex>` **(recommended in UI)** and the legacy form `https://<host>/mcp/r/<64-char-hex>`.
...
T3AF > MCP Tools, then smoke-test a few representative calls.
...
See [MCP Tools](/T3AF/Integrations/MCPTools/Index#ns-t3af-mcp-tools) for the full Core catalog and
[MCP Server](/T3AF/Integrations/MCPServer/Index#ns-t3af-mcp-server) for connection details.
...
See also [Configuration](/T3AF/Configuration/Index#ns-t3af-configuration) and [MCP Server](/T3AF/Integrations/MCPServer/Index#ns-t3af-mcp-server).
...
"{\"pid\": 1, \"CType\": \"text\", \"header\": \"MCP test\"}"
