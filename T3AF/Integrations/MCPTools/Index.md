...
<div className="t3-embed"><iframe src="https://app.supademo.com/embed/cmrbpdgzl0f4zqmo5tbj5kbah?utm_source=link" loading="lazy" title="T3AF MCP Tools Demo" allow="clipboard-write" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe></div>
...
These tools ship with T3AF and appear under the **TYPO3 Core** tab in T3AF > MCP Tools when the [MCP Server](/T3AF/Integrations/MCPServer/Index) is enabled.
...
- OAuth and URL tokens are configured on the [MCP Server](/T3AF/Integrations/MCPServer/Index) screen
...
See [MCP Server](/T3AF/Integrations/MCPServer/Index) for connection setup.
