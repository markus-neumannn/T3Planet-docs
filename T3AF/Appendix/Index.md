...
- **AI Context** — Brand profile injected into prompts. See [AI Context](/T3AF/AIContext/Index).
...
- **Governance** — Access control, budgets, and rate limits for AI. See [AI Permissions](/T3AF/GovernanceAndAccess/Index).
- **JSON-LD** — Schema markup format for structured data.
- **MCP** — Model Context Protocol. Connects AI agents to TYPO3. See [MCP Server](/T3AF/MCPServer/Index).
- **Meta description** — Short text shown in Google search results.

## O–T

- **OAuth** — Secure authentication for MCP remote connections.
- **Prompt** — Instruction sent to the AI. See [AI Prompts](/T3AF/AIPrompts/Index).
...
Full API reference: [Developer Guide](/T3AF/DeveloperGuide/Index)

## Related pages

- [What Does It Do?](/T3AF/WhatDoesItDo/Index) — Feature overview
- [Configuration](/T3AF/Configuration/Index) — Extension Configuration keys
- [Helpful Links](/T3AF/HelpfulLinks/Index) — External documentation and API portals
