...
Click **Activate** again after enabling the toggle. See [T3Planet Credits](/T3AF/T3PlanetCredits/Index).
...
Incorrect for current `ns_t3af`. Use TYPO3 12.4+ and PHP 8.2+. See [System Requirements](/T3AF/SystemRequirements/Index).
...
Check [AI Usage & Logs](/T3AF/AIUsageAndLogs/Index) for repeating feature names. May be a script loop. Apply rate limits in [AI Permissions](/T3AF/GovernanceAndAccess/Index).
...
Submit via [Support](/T3AF/Support) or [https://t3planet.de/support](https://t3planet.de/support)
