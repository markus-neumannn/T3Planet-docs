...
**Cost saving** — Cheap model as global default; premium model assigned in [AI Features](/T3AF/AIFeatures/Index) for important tasks.
...
**T3Planet Credits** — Toggle in AI Providers, then click **Activate**. See [T3Planet Credits](/T3AF/T3PlanetCredits/Index).
...
**Module works but child extension fails** — Check [AI Features](/T3AF/AIFeatures/Index) for per-task overrides.

## Security

- Rotate keys every 90 days
- Use one key per environment (dev, staging, live)
- Restrict access via [AI Permissions](/T3AF/GovernanceAndAccess/Index)
...
More links: [Helpful Links](/T3AF/HelpfulLinks/Index)
