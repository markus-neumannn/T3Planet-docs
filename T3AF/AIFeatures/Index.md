...
3. **Global default** provider from [AI Providers](/T3AF/AIProviders/Index)
...
5. Review token usage in [AI Usage & Logs](/T3AF/AIUsageAndLogs/Index)

## Scenario: agency with dev and live keys

Use global default for staging. On production, set SEO to a fast model and Pages to premium. Dev team keeps separate provider rows in [AI Providers](/T3AF/AIProviders/Index) with dev API keys.
