...
description: "Get This Extension for EXT:ns_t3af (T3AF)."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3AF"
...
**T3AF** (`EXT:ns_t3af`) is the shared AI engine for all T3Planet AI extensions.

**Extension key:**`ns_t3af`

**Composer package:**`nitsan/ns-t3af`
...
Then continue with [Installation](/T3AF/Installation/Index) and run [Quick Setup](/T3AF/SetupWizard/Index).
