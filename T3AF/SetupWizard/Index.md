...
- **Brand context** — [AI Context](/T3AF/AIContext/Index)
- **Tune prompts** — [AI Prompts](/T3AF/AIPrompts/Index)
- **Enable governance** — [AI Permissions](/T3AF/GovernanceAndAccess/Index)
- **Connect MCP** — [MCP Server](/T3AF/MCPServer/Index)
- **Daily health check** — [Dashboard](/T3AF/Dashboard/Index)

## Scenario: agency onboarding a new client

1. Install on staging → run wizard with client’s API key or credits
2. Fill [AI Context](/T3AF/AIContext/Index) with brand voice
