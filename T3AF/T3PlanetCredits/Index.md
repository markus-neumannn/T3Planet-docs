...
**Your Own API Keys (BYOK)** — Add provider keys in [AI Providers](/T3AF/AIProviders/Index). Billing goes directly to OpenAI, Anthropic, or other vendors. Best for agencies that already have vendor accounts.
...
Check balance regularly on the [Dashboard](/T3AF/Dashboard/Index).
...
See also [FAQ](/T3AF/FAQ/Index) and [Known Problems](/T3AF/KnownProblems/Index).
