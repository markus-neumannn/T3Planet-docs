---
title: "Custom AI Access / Permissions"
description: "Extend AI access and permissions catalogs."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3AF"
  - "Custom AI Access / Permissions"
sidebarTitle: "Custom AI Access"
---

Use an AI access catalog provider when your extension needs to expose module access, AI feature permissions, or record-level permissions through T3AF.
...
Administrators assign the resulting permissions through **Backend Users** > **Groups** > **Access Lists**.
The optional **T3AF → AI Access / Roles** wizard reads the same merged catalogs.
...
if (!$gate->grantsT3AiTab($GLOBALS['BE_USER'], 'content')) {
    // return 403
}
```
...
Open **T3AF → AI Access / Roles**, select a backend group, and configure the wizard steps or permission matrix tabs.

**Option B — Native backend groups**

1. Grant the custom feature bit under **Custom module options → T3Ai**.
...
- [AI Permissions](/T3AF/GovernanceAndAccess/Index)
