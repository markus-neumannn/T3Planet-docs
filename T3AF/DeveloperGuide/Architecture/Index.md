...
Runtime AI requests resolve through provider rows in [AI Providers](/T3AF/Configuration/AIProviders/Index). Optional extension settings cover translation helpers, Basic Auth, notifications, and MCP switches. See [Configuration](/T3AF/Configuration/Index).
