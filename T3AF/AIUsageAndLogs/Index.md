...
Compare usage trends with credit balance on the [Dashboard](/T3AF/Dashboard/Index).
...
Log detail depends on [AI Permissions](/T3AF/GovernanceAndAccess/Index) privacy level. Configure for GDPR needs before enabling **Full** logging.
...
4. Escalate persistent errors to [Support](/T3AF/Support) with log details

## When logs show high usage

- Check [AI Features](/T3AF/AIFeatures/Index) — bulk tasks may need a cheaper model
- Review [AI Permissions](/T3AF/GovernanceAndAccess/Index) budgets and rate limits
- Ask editors if a script or loop triggered many requests

## When logs show failures

- Run Test connection in [AI Providers](/T3AF/AIProviders/Index)
- Check vendor status and rate limits
- See [Known Problems](/T3AF/KnownProblems/Index) and [FAQ](/T3AF/FAQ/Index)
