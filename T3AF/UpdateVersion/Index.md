...
3. Test provider connection in [AI Providers](/T3AF/AIProviders/Index)
4. Test MCP if enabled — see [MCP Server](/T3AF/MCPServer/Index)
5. Check [AI Usage & Logs](/T3AF/AIUsageAndLogs/Index) for errors after a test AI request
...
- **Upgrade** — Major version jump (for example v1 to v2) — follow [Upgrade Guide](/T3AF/UpgradeGuide/Index) with migration wizards
