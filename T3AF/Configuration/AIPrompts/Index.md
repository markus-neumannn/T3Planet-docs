...
Pair prompts with [AI Context](/T3AF/Configuration/AIContext/Index) for brand voice. Context handles who you are; prompts handle what to do.
...
- You have not yet filled [AI Context](/T3AF/Configuration/AIContext/Index)
- Results are already good — do not over-edit

## Governance note

Prompt changes affect all users. Coordinate with [AI Permissions](/T3AF/Configuration/AIPermissions/Index) before large template changes on production.
