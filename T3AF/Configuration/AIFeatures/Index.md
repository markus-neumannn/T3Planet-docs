...
If no child extension is connected, the feature list stays empty or incomplete. Set a global default provider in [AI Providers](/T3AF/Configuration/AIProviders/Index) first, then override providers for individual features on this page.
</Note>
...
3. **Global default** provider from [AI Providers](/T3AF/Configuration/AIProviders/Index)
...
5. Review token usage in [AI Usage & Logs](/T3AF/Configuration/AIUsageAndLogs/Index)

## Scenario: agency with dev and live keys

Use global default for staging. On production, set SEO to a fast model and Pages to premium. Dev team keeps separate provider rows in [AI Providers](/T3AF/Configuration/AIProviders/Index) with dev API keys.
