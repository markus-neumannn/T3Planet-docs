...
4. Skim **AI Logs** if usage looks unusual — see [AI Usage & Logs](/T3AF/AIUsageAndLogs/Index)

## Status meanings

- **Green** — Provider OK. No action needed.
- **Yellow** — Not tested recently. Run a Test connection in [AI Providers](/T3AF/AIProviders/Index).
- **Red** — Connection failed. Check API key, model ID, and outbound HTTPS.

## Quick links from the dashboard

- **AI Providers** → [AI Providers](/T3AF/AIProviders/Index)
- **MCP Server** → [MCP Server](/T3AF/MCPServer/Index)
- **Quick Setup** → [Quick Setup](/T3AF/SetupWizard/Index)
- **View Logs** → [AI Usage & Logs](/T3AF/AIUsageAndLogs/Index)
...
1. Open [AI Providers](/T3AF/AIProviders/Index) → run **Test connection**
2. Check vendor status page (OpenAI, Anthropic, etc.)
3. Verify firewall allows outbound HTTPS
4. Check [AI Logs](/T3AF/AIUsageAndLogs/Index) for the exact error message
5. See [Known Problems](/T3AF/KnownProblems/Index) if the issue persists
