...
This moves legacy API keys into the AI Providers table. Then verify providers in [AI Providers](/T3AF/AIProviders/Index).
...
1. Flush all caches
2. Re-run health check from [MCP Server](/T3AF/MCPServer/Index)
3. Re-authorize OAuth clients if token lifetime changed

See also [Update Version](/T3AF/UpdateVersion/Index) for routine updates.
