...
<div className="t3-template-landing">
  <div className="t3-landing-hero">
    ...
    <h1 className="t3-landing-title">Start building with T3 ReactBootstrap</h1>
    <p className="t3-landing-subtitle">Everything you need to install, configure, and customize T3 ReactBootstrap in TYPO3. From first setup to production.</p>
  </div>
