...
```
composer req nitsan/ns-protect-site --with-all-dependencies
```
...
![Install Extension](./images/install_extension13.jpeg)

![Activate Typoscript](images/activate_typoscript23.webp)
