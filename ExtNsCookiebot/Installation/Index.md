...
```
composer req nitsan/ns-cookiebot --with-all-dependencies
```
...
Step 4. Select '[Nitsan] Cookiebot' at the field Include static (from extensions):

Step 5. Include '[Nitsan] Cookiebot' at the last place.

![Activate Typoscript](./images/activate_typoscript.webp)

## How to Install TYPO3 Extension ns_cookiebot
