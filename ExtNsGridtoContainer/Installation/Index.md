...
```
composer req nitsan/ns-gridtocontainer --with-all-dependencies
```
...
Step 4. Get it from typo3.org: You can always get the current version from https://extensions.typo3.org/extension/ns_gridtocontainer/ by downloading either the t3x or zip version. Upload the file afterwards in the Extension Manager.
...
Step 4. Select 'Nitsan Migration Gridelements to Container' at the field Include static (from extensions):

Step 5. Include 'Nitsan Migration Gridelements to Container' at the last place.

![Activate Typoscript](./images/activate_typoscript.webp)

## How to Install TYPO3 Extension ns_gridtocontainer
