...
<Note>
If you are installing Template using Composer then you will have to uninstall and re-install TYPO3 Template EXT:ns_theme_t3ShivReva
</Note>
...
![Update Extension Repository](./images/update-ext-repository1.webp)

Step 3: Once Repository is updated, switch back to Installed Extension view. Install your purchased TYPO3 template zip eg., ns_theme_t3reva_1.0.0.zip

![Install T3 Reva Template](./images/T3Reva_installation.webp)
...
![Site Configuration](./images/how_to_configure_site4.webp)
...
Step 1: File structure > Unzip the ns_theme_t3reva_1.0.0.zip from the main package. Then you got frontend zip called - t3reva_reactjs.zip unzip it and Then you will see the following folder/file structure.

![root-folder-structure](images/root-folder-structure4.webp)
...
![landing_screen](./images/landing_screen4.webp)
...
![vercel_login](images/vercel_login4.webp)
