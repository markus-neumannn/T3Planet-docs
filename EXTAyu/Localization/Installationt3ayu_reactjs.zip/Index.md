...
<Note>
If you are installing Template using Composer then you will have to uninstall and re-install TYPO3 Template EXT:ns_theme_t3Ayu
</Note>
...
Step 3: Once Repository is updated, switch back to Installed Extension view. Install your purchased TYPO3 template zip eg., ns_theme_t3ayu_1.0.0.zip

![Install T3 Ayu Template](./images/Ayu_Installation.webp)
...
![Site Configuration](./images/Site_configuration.webp)
...
![Page Tree](./images/page_Tree1.webp)

## Installation t3ayu_reactjs
...
![landing_screen](./images/landing_screen1.webp)
