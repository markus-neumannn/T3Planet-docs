...
**Step 1.** Get Frontend Reactjs/Nextjs app-code from /typo3conf/ext/ns_theme_t3ayu/frontend_t3ayu.zip/ You should able to see the following structure once unzip.

![root-folder-structure](images/root-folder-structure.webp)
...
![vercel_login](images/vercel_login.webp)
