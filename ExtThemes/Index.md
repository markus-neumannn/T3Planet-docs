...
keywords:
  ...
  - "ExtThemes"
  - "TYPO3 Templates"
sidebarTitle: "TYPO3 Templates"
---

<div className="t3-template-landing">
  <div className="t3-landing-hero">
    <p className="t3-landing-eyebrow">TYPO3 Templates</p>
    <h1 className="t3-landing-title">Start building with TYPO3 Templates</h1>
    <p className="t3-landing-subtitle">Everything you need to install, configure, and customize T3Planet TYPO3 templates. From first setup to production.</p>
  </div>
