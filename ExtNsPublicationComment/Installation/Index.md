...
Get the extension
  ...
  <Step title="Step 3">
Get it from the Extension Manager: Press the “Retrieve/Update” button and search for the extension key ns_publication_comment and import the extension from the repository.
  </Step>
  <Step title="Step 4">
...
You must need to install the "publication" extension from the typo3 repository.

</Note>

## How to Install TYPO3 Extension ns_publicationcomment
