...
```
composer require nitsan/ns-snow --with-all-dependencies
```
...
Step 4. Get it from typo3.org: You can always get the current version from https://extensions.typo3.org/extension/ns_snow/ by downloading either the t3x or zip version. Upload the file afterwards in the Extension Manager.
...
## How to Install TYPO3 Extension ns_snow
...
![Install Extension](./images/install_extension14.jpeg)

![Activate Typoscript](images/activate_typoscript24.webp)
