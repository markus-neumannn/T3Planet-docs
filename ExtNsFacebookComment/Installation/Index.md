...
```
composer require nitsan/ns-facebook-comment --with-all-dependencies
```
...
Step 3. Get it from the Extension Manager: Press the “Retrieve/Update” button and search for the extension key ns_facebook_comment and import the extension from the repository.

Step 4. Get it from typo3.org: You can always get the current version from https://extensions.typo3.org/extension/ns_facebook_comment/ by downloading either the t3x or zip version. Upload the file afterwards in the Extension Manager.
...
Step 4. Select 'Nitsan Facebook Comment' at the field Include static (from extensions):

Step 5. Include 'Nitsan Facebook Comment' at the last place.

![Activate Typoscript](./images/activate_typoscript.webp)

## How to Install TYPO3 Extension ns_facebook_comment
...
![Install Extension](./images/install_extension5.jpeg)

![Activate Typoscript](./images/activate_typoscript11.jpeg)
