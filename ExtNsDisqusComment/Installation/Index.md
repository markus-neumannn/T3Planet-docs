...
```
composer require nitsan/ns-disqus-comments --with-all-dependencies
```
...
Step 3. Get it from the Extension Manager: Press the “Retrieve/Update” button and search for the extension key ns_disqus_comments and import the extension from the repository.
...
Step 4. Select 'Nitsan Disqus Comment' at the field Include static (from extensions):

Step 5. Include 'Nitsan Disqus Comment' at the last place.

![Activate Typoscript](./images/activate_typoscript.webp)

## How to Install TYPO3 Extension ns_ns-disqus-comments
