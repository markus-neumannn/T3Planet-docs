...
Compare usage trends with credit balance on the [Dashboard](/en/latest/ExtNsT3AF/Dashboard/Index).
...
Log detail depends on [AI Permissions](/en/latest/ExtNsT3AF/Configuration/AIPermissions/Index) privacy level. Configure for GDPR needs before enabling **Full** logging.
...
- Check [AI Features](/en/latest/ExtNsT3AF/AIFeatures/Index) — bulk tasks may need a cheaper model
- Review [AI Permissions](/en/latest/ExtNsT3AF/Configuration/AIPermissions/Index) budgets and rate limits
- Ask editors if a script or loop triggered many requests

## When logs show failures

- Run Test connection in [AI Providers](/en/latest/ExtNsT3AF/AIProviders/Index)
- Check vendor status and rate limits
- See [Known Problems](/en/latest/ExtNsT3AF/KnownProblems/Index) and [FAQ](/en/latest/ExtNsT3AF/FAQ/Index)
