...
- **AI Context** — Brand profile injected into prompts. See [AI Context](/en/latest/ExtNsT3AF/AIContext/Index).
...
- **Governance** — Access control, budgets, and rate limits for AI. See [AI Permissions](/en/latest/ExtNsT3AF/Configuration/AIPermissions/Index).
- **JSON-LD** — Schema markup format for structured data.
- **MCP** — Model Context Protocol. Connects AI agents to TYPO3. See [MCP Server](/en/latest/ExtNsT3AF/MCPServer/Index).
- **Meta description** — Short text shown in Google search results.

## O–T

- **OAuth** — Secure authentication for MCP remote connections.
- **Prompt** — Instruction sent to the AI. See [AI Prompts](/en/latest/ExtNsT3AF/AIPrompts/Index).
...
Full API reference: [Developer Guide](/en/latest/ExtNsT3AF/DeveloperGuide/Index)

## Related pages

- [What Does It Do?](/en/latest/ExtNsT3AF/WhatDoesItDo/Index) — Feature overview
- [Configuration](/en/latest/ExtNsT3AF/Configuration/Index) — Extension Configuration keys
- [Helpful Links](/en/latest/ExtNsT3AF/HelpfulLinks/Index) — External documentation and API portals
