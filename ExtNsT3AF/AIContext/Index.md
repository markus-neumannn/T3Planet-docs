---
title: "AI Context"
description: "AI Context for EXT:ns_t3af (T3AF)."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3AF"
  - "ns_t3af"
sidebarTitle: "AI Context"
---
...
## Tips for German clients

- State **Sie** or **du** explicitly in language style
- Note if content is DE, EN, or both
- Add terms that must never be translated (brand names, product names)
- Keep formal tone consistent with your corporate language guide

## Best practices

**Do:**

- Keep the profile short (about one page)
- Update when you rebrand
- Test on one AI request before rolling out to all editors

**Don’t:**

- Paste an entire brand manual (too long for prompts)
- Leave outdated company names
- Roll out blindly without a test request
...
- After [AI Prompts](/en/latest/ExtNsT3AF/AIPrompts/Index) changes still produce off-brand text
...
See also [AI Prompts](/en/latest/ExtNsT3AF/AIPrompts/Index) for task-specific instructions.
