...
description: "Custom Feature Cards for EXT:ns_t3af (T3AF)."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3AF"
  - "ns_t3af"
sidebarTitle: "Custom Feature Cards"
---

Use custom AI Features when your extension needs settings cards inside T3AF > AI Features. These cards are used for extension-specific AI configuration such as feature toggles, defaults, API-related options, and provider choices.

## Purpose

AI Features are not prompt templates and not MCP tools. They are configuration surfaces for extensions that use T3AF.

T3AF renders the card, drawer, AJAX save/load flow, and per-site storage. Your extension provides the card metadata, allowed settings scope, and field schema.
...
Read settings through the T3AF settings API instead of parsing extension configuration manually. The saved values are merged with schema defaults.
...
- [Custom AI Prompts](/en/latest/ExtNsT3AF/DeveloperGuide/CustomPromptCatalogs/Index)
