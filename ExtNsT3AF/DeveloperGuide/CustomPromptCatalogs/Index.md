---
title: "Custom Prompt Catalogs"
description: "Custom Prompt Catalogs for EXT:ns_t3af (T3AF)."
keywords:
  - "TYPO3"
  - "T3Planet"
  - "T3AF"
  - "ns_t3af"
sidebarTitle: "Custom Prompt Catalogs"
---

Use a custom prompt catalog when your extension needs editable LLM instruction templates in T3AF > AI Prompts. Prompt catalogs let your extension ship built-in defaults while allowing editors to create project-specific overrides.
...
T3AF provides the backend module and shared storage. Your extension provides the prompt contracts, category metadata, and runtime resolver.
...
- [AI Prompts](/ExtNsT3AF/Configuration/AIPrompts/Index)
